	...
	<div class="addEdit-block" :style='{"padding":"85px 30px 30px","fontSize":"14px","color":"#666","background":"none"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"border":"0px solid #eee","padding":"20px 0","margin":"0 0 2px 0","color":"inherit","borderRadius":"0px","background":"none","width":"48%","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="美食分类" prop="meishifenlei">
				...
				<el-form-item :style='{"border":"0px solid #eee","padding":"20px 0","margin":"0 0 2px 0","color":"inherit","borderRadius":"0px","background":"none","width":"48%","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="预定数量" prop="yudingshuliang">
					<el-input v-model.number="ruleForm.yudingshuliang" placeholder="预定数量" clearable  :readonly="ro.yudingshuliang"></el-input>
				</el-form-item>
				<el-form-item :style='{"border":"0px solid #eee","padding":"20px 0","margin":"0 0 2px 0","color":"inherit","borderRadius":"0px","background":"none","width":"48%","fontSize":"inherit"}' v-else class="input" label="预定数量" prop="yudingshuliang">
					<el-input v-model="ruleForm.yudingshuliang" placeholder="预定数量" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"border":"0px solid #eee","padding":"20px 0","margin":"0 0 2px 0","color":"inherit","borderRadius":"0px","background":"none","width":"48%","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="预定金额" prop="yudingjine">
					<el-input v-model="yudingjine" placeholder="预定金额" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"border":"0px solid #eee","padding":"20px 0","margin":"0 0 2px 0","color":"inherit","borderRadius":"0px","background":"none","width":"48%","fontSize":"inherit"}' class="input" v-else-if="ruleForm.yudingjine" label="预定金额" prop="yudingjine">
					<el-input v-model="ruleForm.yudingjine" placeholder="预定金额" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"border":"0px solid #eee","padding":"20px 0","margin":"0 0 2px 0","color":"inherit","borderRadius":"0px","background":"none","width":"48%","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="美食评分" prop="meishipingfen">
					<el-input v-model="ruleForm.meishipingfen" placeholder="美食评分" clearable  :readonly="ro.meishipingfen"></el-input>
				</el-form-item>
				<el-form-item :style='{"border":"0px solid #eee","padding":"20px 0","margin":"0 0 2px 0","color":"inherit","borderRadius":"0px","background":"none","width":"48%","fontSize":"inherit"}' v-else class="input" label="美食评分" prop="meishipingfen">
					<el-input v-model="ruleForm.meishipingfen" placeholder="美食评分" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"border":"0px solid #eee","padding":"20px 0","margin":"0 0 2px 0","color":"inherit","borderRadius":"0px","background":"none","width":"48%","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="e彷姓名" prop="epangxingming">
					<el-input v-model="ruleForm.epangxingming" placeholder="e彷姓名" clearable  :readonly="ro.epangxingming"></el-input>
				</el-form-item>
				<el-form-item :style='{"border":"0px solid #eee","padding":"20px 0","margin":"0 0 2px 0","color":"inherit","borderRadius":"0px","background":"none","width":"48%","fontSize":"inherit"}' v-else class="input" label="e彷姓名" prop="epangxingming">
					<el-input v-model="ruleForm.epangxingming" placeholder="e彷姓名" readonly></el-input>
				</el-form-item>
			</template>
...
export default {
	...
	computed: {
		...
		yudingjine:{
			get: function () {
				return 1*this.ruleForm.jiage*this.ruleForm.yudingshuliang
			}
		},
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='yudingjine'){
							this.ruleForm.yudingjine = obj[o];
							this.ro.yudingjine = true;
							continue;
						}
						if(o=='meishididian'){
						...
						if(o=='epangxingming'){
							this.ruleForm.epangxingming = obj[o];
							this.ro.epangxingming = true;
							continue;
						}
				}
			...
			this.$http({
				...
				if (data && data.code === 0) {
					...
					if(((json.epangxingming!=''&&json.epangxingming) || json.epangxingming==0) && this.$storage.get("role")!="管理员"){
						this.ruleForm.epangxingming = json.epangxingming
						this.ro.epangxingming = true;
					}
				} else {
    ...
    // 提交
    onSubmit() {
        this.ruleForm.yudingjine = this.yudingjine
				...
				this.$http({ 
					...
					if (data && data.code === 0) { 
						if(data.data.total>=crossoptnum) {
							...
							this.$http({
								url: `meishiyuding/${!this.ruleForm.id ? "save" : "update"}`,
								method: "post",
								data: this.ruleForm
							}).then(({ data }) => {
								if (data && data.code === 0) {
									this.$message({
										...
										onClose: () => {
											...
											this.parent.meishiyudingCrossAddOrUpdateFlag = false;
											this.parent.search();
