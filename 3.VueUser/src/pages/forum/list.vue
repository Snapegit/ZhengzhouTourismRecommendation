...
<div class="forum-preview" :style='{"width":"100%","padding":"30px 7% 40px","margin":"0px auto","position":"relative","background":"#fff"}'>
    <div :style='{"width":"100%","lineHeight":"56px","textAlign":"center","background":"url(http://codegen.caihongy.cn/20230921/eb4b56c7d55142c4b9339e032022bfb5.png) repeat-x center bottom","height":"66px"}'>
		<div :style='{"padding":"0 20px","color":"#333","textAlign":"center","background":"none","display":"inline-block","width":"auto","fontSize":"20px"}'>论坛</div>
	</div>
    <el-form :style='{"padding":"10px 0","margin":"10px 0","alignItems":"center","flexWrap":"wrap","background":"none","display":"flex","width":"100%","height":"auto"}' :inline="true" :model="formSearch" class="list-form-pv">
		...
		<div :style='{"display":"flex"}'>
			...
			<el-button class="pubBtn" type="primary" @click="toForumAdd">
				<span class="icon iconfont icon-shouye-zhihui" :style='{"color":"#333","margin":"0 10px 0 0","fontSize":"14px"}'></span>
				发布帖子
			</el-button>
		</div>
    </el-form>
